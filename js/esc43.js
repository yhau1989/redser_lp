const endpoint_tags_bof = 'http://138.122.108.33:8030/resdec/list_items/?var_environment_id=1&relationship_type_id=3&item=';
const endpoint_algorithms_bof = "http://138.122.108.33:8030/resdec/list_algorithms/?relationship_type_id=3";
...
async function loadRecomendations_bof(algorithm_id, number_recommendations, item_evaluated) {
    ...
    var url_endpoint = `http://138.122.108.33:8030/resdec/transition_components_based_features/?relationship_type_id=3&var_environment_id=1&algorithm_id=${algorithm_id}&username=${userLogon}&number_recommendations=${number_recommendations}&item_evaluated=${item_evaluated}`;
...
function loadTagsByPlugin_bof(plugin) {
    ...
    const url = `http://138.122.108.33:8030/resdec/list_features_item/?var_environment_id=1&item=${plugin}`;
    console.log(url);
    $.getJSON(url,
        function(data) {
